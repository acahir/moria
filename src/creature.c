...
/* For "DIED_FROM" string	   */
  ...
  while ((*attstr != 0) && !death) {
    ...
    case 11: /*Paralysis attack*/
      ...
      break;
    case 12: /*Steal Money    */
      if ((test_hit(5, (int)r_ptr->level, 0, (int)py.misc.lev, CLA_MISC_HIT)) &&
          (py.misc.au > 0))
        flag = TRUE;
      break;
    case 13: /*Steal Object   */
      if ((test_hit(2, (int)r_ptr->level, 0, (int)py.misc.lev, CLA_MISC_HIT)) &&
          (inven_ctr > 0))
        flag = TRUE;
      break;
    case 14: /*Poison	       */
...
int32u *rcmove;
{
  ...
  if ((r_ptr->cmove & CM_MULTIPLY) && (MAX_MON_MULT >= mon_tot_mult) &&
    ...
    if ((k < 4) && (randint(k * MON_MULT_ADJ) == 1))
      if (multiply_monster((int)m_ptr->fy, (int)m_ptr->fx, (int)m_ptr->mptr,
                           monptr))
#ifdef ATARIST_MWC
        *rcmove |= holder;
#else
