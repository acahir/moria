...
/*	 X = Open; . = Closed					*/
char days[7][29] = {
    "SUN:XXXXXXXXXXXXXXXXXXXXXXXX", "MON:XXXXXXXX.........XXXXXXX",
    "TUE:XXXXXXXX.........XXXXXXX", "WED:XXXXXXXX.........XXXXXXX",
    "THU:XXXXXXXX.........XXXXXXX", "FRI:XXXXXXXX.........XXXXXXX",
...
int (*store_buy[MAX_STORES])() = {general_store, armory,    weaponsmith,
...
char *metals[MAX_METALS] = {"Aluminum",      "Cast Iron",    "Chromium",
                            "Copper",        "Gold",         "Iron",
...
char *amulets[MAX_AMULETS] = {"Amber",  "Driftwood", "Coral",         "Agate",
                              "Ivory",  "Obsidian",  "Bone",          "Brass",
                              "Bronze", "Pewter",    "Tortoise Shell"};
